...
Using the Jelly language reference (`~/.github/instructions/jelly.instructions.md`, loaded automatically when a `.jelly` file is open), identify the root cause. Cross-reference with the capability index and syntax quick-reference.
