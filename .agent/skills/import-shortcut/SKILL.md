...
```sh
make decompile FILE=<file>.shortcut
```

Then read the resulting JSON file at `/tmp/<name>.json`.
...
2. **Color** — valid `#Color` value (refer to `~/.github/instructions/jelly.instructions.md` Section 11)
