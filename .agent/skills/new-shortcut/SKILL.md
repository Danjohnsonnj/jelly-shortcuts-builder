...
3. **Color** — valid `#Color` value (e.g. `red`, `blue`, `green`, `yellow`, `orange`, `purple`, `pink`, `teal`, `indigo`, `gray`). Refer to `~/.github/instructions/jelly.instructions.md` for the full list.
...
Use `.agent/skills/new-shortcut/template.jelly` as the base. Create the file at: `{category}/{kebab-case-name}.jelly`
